			...
			$this->start_controls_section(
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .sina-banner-pbtn' => 'text-align: {{VALUE}};',
						],
					]
				);
			...
			$this->start_controls_section(
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .sina-banner-sbtn' => 'text-align: {{VALUE}};',
						],
					]
				);
				...
				<div class="sina-slider-content sina-bg-cover" style="background-image: url(<?php echo esc_url( $slide['image']['url'] ); ?>);">
					...
					<div class="sina-banner-container elementor-repeater-item-<?php echo esc_attr( $slide[ '_id' ] ); ?>">
						...
						<?php if ( $slide['title'] ): ?>
							...
							<?php printf('<%4$s %1$s data-animation="animated %2$s">%3$s</%4$s>', $this->get_render_attribute_string( $title_key ), esc_attr($slide['title_anim']), wp_kses_post($slide['title'].$title_span), sina_ext_escape_tags( $slide['title_tag'] )); ?>
						<?php endif; ?>

						<?php if ( $slide['subtitle'] ): ?>
							<?php printf('<%4$s %1$s data-animation="animated %2$s">%3$s</%4$s>', $this->get_render_attribute_string( $subtitle_key ), esc_attr($slide['subtitle_anim']), wp_kses_post($slide['subtitle']), sina_ext_escape_tags( $slide['subtitle_tag'] )); ?>
						<?php endif; ?>

						<?php if ( $slide['desc'] ): ?>
							<?php printf('<div %1$s data-animation="animated %2$s">%3$s</div>', $this->get_render_attribute_string( $desc_key ), esc_attr($slide['desc_anim']), wp_kses_post($slide['desc'])); ?>
						<?php endif; ?>
